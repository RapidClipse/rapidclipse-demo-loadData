...
public class EmployeePhotoColumn extends XdevHorizontalLayout {
	...
	public static class Generator implements ColumnGenerator {
		...
		public Object generateCell(final Table table, final Object itemId, final Object columnId) {
			...
			return new EmployeePhotoColumn(table, itemId, columnId);
		}
	}
	...
	private EmployeePhotoColumn(final Table customizedTable, final Object itemId, final Object columnId) {
		super();
		...
		final byte[] picture = getBean().getPhoto();
		...
		final StreamResource streamResource = new StreamResource(myStreamSource, "filenameIfAvailable" + getBean().getEmployeeid());
	...
	public Employee getBean() {
		return ((XdevTable<Employee>) getTable()).getBeanItem(getItemId()).getBean();
	}
